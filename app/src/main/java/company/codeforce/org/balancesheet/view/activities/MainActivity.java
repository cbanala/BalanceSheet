...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.other_deductions_item) {
            intent = new Intent(this, OtherDeductionsActivity.class);
            startActivity(intent);

        } else if (id == R.id.vendor_hours) {
            intent = new Intent(this, VendorHoursActivity.class);
            startActivity(intent);
        } else if (id == R.id.vendor_payments) {
